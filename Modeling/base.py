...
def _create_conv_block(block_index, in_channels, out_channels, kernel_size, stride, bn, activation="Mish"):
    block = nn.Sequential()
...
def _create_trans_conv_block(block_index, in_channels, out_channels, kernel_size, stride, bn, activation="Mish"):
    block = nn.Sequential()
